...
package com.example.gate360player.gles;
...
import com.example.gate360player.R;
...
public class SphericalSceneRenderer {
    ...
    public SphericalSceneRenderer(Context context) {
        shaderProgram = new ShaderProgram(
                SphericalVideoPlayer.readRawTextFile(context, R.raw.video_vertex_shader),
                SphericalVideoPlayer.readRawTextFile(context, R.raw.video_fragment_shader));
